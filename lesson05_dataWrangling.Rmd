...
For today's lesson, you will want to download/make a copy of the Github repository [https://github.com/melindahiggins2000/N736Fall2017_lesson05](https://github.com/melindahiggins2000/N736Fall2017_lesson05). This repo contains 3 datasets we will be working with in the exercises below: `dataA.csv`; `dataB.csv` and `dataC.csv`.
